...
- (void)prepareForSegue:(NSStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"joinChannel"]) {
        ...
        switch (self.audioModePopUpButton.indexOfSelectedItem) {
            case 0: mode = AudioCRMode_SDKCapture_SDKRender; break;
            case 1: mode = AudioCRMode_ExterCapture_SDKRender; break;
            case 2: mode = AudioCRMode_SDKCapture_ExterRender; break;
